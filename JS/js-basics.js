...
const numSquared = Number(prompt("Введите число:"));
...
const numMin = Number(prompt("Введите минуты:"));
...
const value5 = Number(prompt("Угадай чиcло:"));
if (value5 === 10) {
  alert("Верно.");
} else {
  alert("Не угадал.");
...
for (const value8; value8 !== example; ) {
